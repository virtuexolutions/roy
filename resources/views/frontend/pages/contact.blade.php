...
@section('content')
									...
									<div class="row">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="subject" class="form-control" type="text" id="subject" placeholder="Enter Subject">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
    ...
    margin-top: 10px;
    color: #fff;
    background: #FB9D4A;' class="btn btn-get-started scrollto ">Send Message</button>
											</div>
										</div>
									</div>
								</form>
