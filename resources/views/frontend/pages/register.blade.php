                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="" required="required" value="{{old('name')}}">
                                        @error('name')
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control" placeholder="" required="required" value="{{old('email')}}">
                                        @error('email')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="form-group login-btn">
                                        ...
                                        <button class="btn btn-active" style="background-color: #FB9D4A;
    border-radius: 20px;
    color: #fff;
    margin-left: 18px;" type="submit">Register</button>
                                        OR
