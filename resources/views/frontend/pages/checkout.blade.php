                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <!-- <form-group>
                                                <input name="payment_method" id="cod"  type="radio" value="cod"> <label> Cash On Delivery</label><br>
                                ...
                                <div class="single-widget get-button">
                                    <div class="content">
                                        <div class="button">
                                            <button type="submit" class="btn " style="background-color: #FB9D4A;border-radius: 20px;color: #fff;margin-left: 18px;">proceed to checkout</button>
                                        </div>
                                    </div>
                                </div>
                                <!--/ End Button Widget -->
